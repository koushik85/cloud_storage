...
public class SendMailExample {
	...
	public void main(String sendermail,String code)throws MessagingException {
		...
		// Recipient's email ID needs to be mentioned.
			String sender_email = "raghu26297@gmail.com"; //enter ur  emailid
		//	String sender_password = "your password";
			...
			String message_mi = "Your one time password is "+code;
...
{
	String sender_email = "raghu26297@gmail.com",
			sender_password = "Raghu@4171"; //password
